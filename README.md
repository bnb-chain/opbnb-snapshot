...
- Path-Base-State-Scheme(recommand):
    - url: https://pub-2ea2209b4ee74f4398c5ac50c3b2efeb.r2.dev/geth-mainnet-pbss-20251229.tar.gz 
    - sha256 checksum: 2f2f614ef73366676800423bac989787483a0592ea3b362404db69b4900e5124
- Archived:  
...
```bash
wget -q -O - https://pub-2ea2209b4ee74f4398c5ac50c3b2efeb.r2.dev/geth-mainnet-pbss-20251229.tar.gz | tar -xvf -
```

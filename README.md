...
- Path-Base-State-Scheme(recommand):
    - url: https://pub-2ea2209b4ee74f4398c5ac50c3b2efeb.r2.dev/geth-mainnet-pbss-20251015.tar.gz 
    - sha256 checksum: bb945410f0929651839a1bd8220483a62024bc5e7bb7fbdd9b26ebf394be9562
- Archived:  
...
```bash
wget -q -O - https://pub-2ea2209b4ee74f4398c5ac50c3b2efeb.r2.dev/geth-mainnet-pbss-20251015.tar.gz | tar -xvf -
```

...
- Path-Base-State-Scheme(recommand):
    - url: https://pub-2ea2209b4ee74f4398c5ac50c3b2efeb.r2.dev/geth-mainnet-pbss-20250425.tar.gz 
    - sha256 checksum: 665ed70f7e74c202abedf562fa5f5a50a8aac5e1e697b251244d751d12375596
- Archived:  
...
- Pruned Archived: (Note that the pruned snapshot has erased state data before block height: 19598373)
    - url:  https://pub-2ea2209b4ee74f4398c5ac50c3b2efeb.r2.dev/geth-mainnet-prune-20250425.tar.gz
    - sha256 checksum: 


### *Testnet*
- Path-Base-State-Scheme(recommand):  
    - url: https://pub-2ea2209b4ee74f4398c5ac50c3b2efeb.r2.dev/geth-testnet-pbss-20250425.tar.gz
    - sha256 checksum: de016b631133c90b18ae7248368ee5db485a6d49bd1b6cb482599a7f4568a42c
- Archived:
...
```bash
wget -q -O - https://pub-2ea2209b4ee74f4398c5ac50c3b2efeb.r2.dev/geth-mainnet-pbss-20250425.tar.gz | tar -xvf -
```

...
- Path-Base-State-Scheme(recommand):
    - url: https://pub-2ea2209b4ee74f4398c5ac50c3b2efeb.r2.dev/geth-mainnet-pbss-20260315.tar.gz 
    - sha256 checksum: a8662e5a333854482e951c1248446d1b04b8287cf24b4731399a4df28bcfe98f
- Archived:  
...
```bash
wget -q -O - https://pub-2ea2209b4ee74f4398c5ac50c3b2efeb.r2.dev/geth-mainnet-pbss-20260315.tar.gz | tar -xvf -
```

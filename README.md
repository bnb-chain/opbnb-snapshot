...
- Path-Base-State-Scheme(recommand):
    - url: https://pub-2ea2209b4ee74f4398c5ac50c3b2efeb.r2.dev/geth-mainnet-pbss-20250404.tar.gz 
    - sha256 checksum: d90b149f8e8cd98634dfd8f5156dc6e064089c9febbb830c04d1159a1dfc5129
- Archived:  
...
- Pruned Archived: (Note that the pruned snapshot has erased state data before block height: 19598373)
    - url:  https://pub-2ea2209b4ee74f4398c5ac50c3b2efeb.r2.dev/geth-mainnet-prune-20250404.tar.gz
    - sha256 checksum: 
...
```bash
wget -q -O - https://pub-2ea2209b4ee74f4398c5ac50c3b2efeb.r2.dev/geth-mainnet-pbss-20250404.tar.gz | tar -xvf -
```

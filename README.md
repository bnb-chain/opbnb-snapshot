...
- Path-Base-State-Scheme(recommand):
    - url: https://pub-2ea2209b4ee74f4398c5ac50c3b2efeb.r2.dev/geth-mainnet-pbss-20250915.tar.gz 
    - sha256 checksum: 89c8105bdbbd98947c4c41881fae156f2d62b91de93bec75cef712ee2edca745
- Archived:  
...
```bash
wget -q -O - https://pub-2ea2209b4ee74f4398c5ac50c3b2efeb.r2.dev/geth-mainnet-pbss-20250915.tar.gz | tar -xvf -
```

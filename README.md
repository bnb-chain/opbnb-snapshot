...
- Path-Base-State-Scheme(recommand):
    - url: https://pub-2ea2209b4ee74f4398c5ac50c3b2efeb.r2.dev/geth-mainnet-pbss-20241227.tar.gz 
    - sha256 checksum: 205c882a1de06a624261332b61534fee3821dde47a6c4290bae1ffa5ad02e598
- Archived:  
...
```bash
wget -q -O - https://pub-2ea2209b4ee74f4398c5ac50c3b2efeb.r2.dev/geth-mainnet-pbss-20241227.tar.gz | tar -xvf -
```

...
- Path-Base-State-Scheme(recommand):
    - url: https://pub-2ea2209b4ee74f4398c5ac50c3b2efeb.r2.dev/geth-mainnet-pbss-20260301.tar.gz 
    - sha256 checksum: bea7e279d147899bddf69b468392b5d8b78a78d64abdc47990954d55c506feec
- Archived:  
...
```bash
wget -q -O - https://pub-2ea2209b4ee74f4398c5ac50c3b2efeb.r2.dev/geth-mainnet-pbss-20260301.tar.gz | tar -xvf -
```
